...
bool g_boot_red_on = false;
char g_loop_count=0;
bool bat_Is_Charging=0;

extern int mt65xx_leds_brightness_set(int type, int level); //huangjianlong
...
static struct mt_battery_charging_custom_data default_charging_data = {
	...
	.max_discharge_temperature = 50,//60,
	...
	.ac_charger_current = 185600,//204800,
...
static ssize_t show_bat_charging_data(struct device *dev, struct device_attribute *attr, char *buf)
{
	int ret_value = 1;
	char *ptr = buf;

	ret_value=p_bat_charging_data->battery_cv_voltage;	
	ptr +=sprintf(ptr, "battery_cv_voltage= %d \r\n", 
		 ret_value);	

	ret_value=p_bat_charging_data->v_charger_max;
	ptr +=sprintf(ptr, "v_charger_max= %d \r\n", 
		 ret_value);	
	
	ret_value=p_bat_charging_data->v_charger_min;
	ptr +=sprintf(ptr, "v_charger_min= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->max_discharge_temperature;
	ptr +=sprintf(ptr, "max_discharge_temperature= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->min_discharge_temperature;
	ptr +=sprintf(ptr, "min_discharge_temperature= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->max_charge_temperature;
	ptr +=sprintf(ptr, "max_charge_temperature= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->min_charge_temperature;
	ptr +=sprintf(ptr, "min_charge_temperature= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->use_avg_temperature;
	ptr +=sprintf(ptr, "use_avg_temperature= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->usb_charger_current;
	ptr +=sprintf(ptr, "usb_charger_current= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->ac_charger_current;
	ptr +=sprintf(ptr, "ac_charger_current= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->ac_charger_input_current;
	ptr +=sprintf(ptr, "ac_charger_input_current= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->non_std_ac_charger_current;
	ptr +=sprintf(ptr, "non_std_ac_charger_current= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->charging_host_charger_current;
	ptr +=sprintf(ptr, "charging_host_charger_current= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->apple_0_5a_charger_current;
	ptr +=sprintf(ptr, "apple_0_5a_charger_current= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->apple_1_0a_charger_current;
	ptr +=sprintf(ptr, "apple_1_0a_charger_current= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->apple_2_1a_charger_current;
	ptr +=sprintf(ptr, "apple_2_1a_charger_current= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->ta_start_battery_soc;
	ptr +=sprintf(ptr, "ta_start_battery_soc= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->ta_stop_battery_soc;
	ptr +=sprintf(ptr, "ta_stop_battery_soc= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->ta_ac_9v_input_current;
	ptr +=sprintf(ptr, "ta_ac_9v_input_current= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->ta_ac_7v_input_current;
	ptr +=sprintf(ptr, "ta_ac_7v_input_current= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->ta_ac_charging_current;
	ptr +=sprintf(ptr, "ta_ac_charging_current= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->ta_9v_support;
	ptr +=sprintf(ptr, "ta_9v_support= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->temp_pos_60_threshold;
	ptr +=sprintf(ptr, "temp_pos_60_threshold= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->temp_pos_60_thres_minus_x_degree;
	ptr +=sprintf(ptr, "temp_pos_60_thres_minus_x_degree= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->temp_pos_45_threshold;
	ptr +=sprintf(ptr, "temp_pos_45_threshold= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->temp_pos_45_thres_minus_x_degree;
	ptr +=sprintf(ptr, "temp_pos_45_thres_minus_x_degree= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->temp_pos_10_threshold;
	ptr +=sprintf(ptr, "temp_pos_10_threshold= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->temp_pos_10_thres_plus_x_degree;
	ptr +=sprintf(ptr, "temp_pos_10_thres_plus_x_degree= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->temp_pos_0_threshold;
	ptr +=sprintf(ptr, "temp_pos_0_threshold= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->temp_pos_0_thres_plus_x_degree;
	ptr +=sprintf(ptr, "temp_pos_0_thres_plus_x_degree= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->temp_neg_10_threshold;
	ptr +=sprintf(ptr, "temp_neg_10_threshold= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->temp_neg_10_thres_plus_x_degree;
	ptr +=sprintf(ptr, "temp_neg_10_thres_plus_x_degree= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->jeita_temp_above_pos_60_cv_voltage;
	ptr +=sprintf(ptr, "jeita_temp_above_pos_60_cv_voltage= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->jeita_temp_pos_45_to_pos_60_cv_voltage;
	ptr +=sprintf(ptr, "jeita_temp_pos_45_to_pos_60_cv_voltage= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->jeita_temp_pos_10_to_pos_45_cv_voltage;
	ptr +=sprintf(ptr, "jeita_temp_pos_10_to_pos_45_cv_voltage= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->jeita_temp_pos_0_to_pos_10_cv_voltage;
	ptr +=sprintf(ptr, "jeita_temp_pos_0_to_pos_10_cv_voltage= %d \r\n", 
		 ret_value);
	
	ret_value=p_bat_charging_data->jeita_temp_neg_10_to_pos_0_cv_voltage;
	ptr +=sprintf(ptr, "jeita_temp_neg_10_to_pos_0_cv_voltage= %d \r\n", 
		 ret_value);	
	
	ret_value=p_bat_charging_data->jeita_temp_below_neg_10_cv_voltage;
	ptr +=sprintf(ptr, "jeita_temp_below_neg_10_cv_voltage= %d \r\n", 
		 ret_value);	
...
static ssize_t store_bat_charging_data(struct device *dev, struct device_attribute *attr,
				      const char *buf, size_t size)
{
	int ret, bat_charging_data_param = 0;
	ret = kstrtoint(buf, 0, &bat_charging_data_param);
	if (ret) {
		pr_err("wrong format!\n");
		return size;
	}

	//if (bat_charging_data_param == 1)
	//bat_charging_data_flag=bat_charging_data_param;
	//printk("lwj--bat_charging_data_flag=%d\n",bat_charging_data_flag);
	
	return size;
}

static DEVICE_ATTR(bat_charging_data, 0664, show_bat_charging_data, store_bat_charging_data);
...
static bool mt_battery_100Percent_tracking_check(void)
{
	...
	if (BMT_status.bat_full == true) {	/* charging full first, UI tracking to 100% */
		...
		printk("lwj[Battery] mt_battery_100percent_tracking(), Charging full first UI(%d), reset(%d) \r\n",
			    BMT_status.UI_SOC, resetBatteryMeter);
		...
		if (BMT_status.UI_SOC >= 99 && battery_meter_get_battery_current_sign()) {
			...
			battery_log(BAT_LOG_FULL,
				    ...
				    BMT_status.UI_SOC);
			/*		
			printk("lwj[Battery] mt_battery_100percent_tracking(), UI full first, keep (%d), reset(%d) \r\n",
				    BMT_status.UI_SOC,resetBatteryMeter);*/
...
static void battery_update(struct battery_data *bat_data)
{
	...
	if(resetBatteryMeter == true)
	{
		if(BMT_status.bat_full!= true)
			printk("lwj--%s--<= SYSTEM_OFF_VOLTAGE ,power off\n",__func__);
		else
			printk("lwj--%s--bat_full, SOC >=99\n",__func__);

		if(BMT_status.charger_exist && bat_Is_Charging==0 && (BMT_status.UI_SOC < 80) && (BMT_status.bat_full!= true))	
		{
			printk("lwj--%s--charger_exist ,no full, but charging current < 0 ,power off\n",__func__);
			printk("lwj--%s--bat_full=%d\n",__func__,BMT_status.bat_full);
...
void mt_battery_GetBatteryData(void)
{
	...
	while ((bat_vol > Battery_charge_max_vol) && (i < 3))
	 {
		msleep(100);//add by lwj 
	 	bat_vol = battery_meter_get_battery_voltage();
	 	printk("zby bat_vol: %d,%d \n",bat_vol,i);
	 	i++;
	}
	...
	while ((charger_vol > p_bat_charging_data->v_charger_max) && (j < 3))
	 {
		msleep(100);//add by lwj 
	 	charger_vol = battery_meter_get_charger_voltage();
	 	printk("zby charger_vol: %d,%d \n",charger_vol,j);
	 	j++;
	 }
	...
	printk("lwj--AvgVbat=(%d),bat_vol=(%d),AvgI=(%d),I=(%d),VChr=(%d),AvgT=(%d),T=(%d),pre_SOC=(%d),SOC=(%d),ZCV=(%d),UI_SOC=(%d)\n",
		    BMT_status.bat_vol, bat_vol, BMT_status.ICharging, ICharging,
		    BMT_status.charger_vol, BMT_status.temperature, temperature,
		    previous_SOC, BMT_status.SOC, BMT_status.ZCV,BMT_status.UI_SOC);
...
static int mt_battery_CheckBatteryTemp(void)
{
	...
	if (BMT_status.temperature >= p_bat_charging_data->max_charge_temperature) {
		printk("lwj--%s--tmp=%d ,max_tmp=%d\n",__func__,BMT_status.temperature,p_bat_charging_data->max_charge_temperature);		
...
//---add by lwj 20170523 ---{
static void mt_battery_notify_badbattery_check(void)
{
	if (g_platform_boot_mode == KERNEL_POWER_OFF_CHARGING_BOOT ||g_platform_boot_mode == LOW_POWER_OFF_CHARGING_BOOT)
	{
	       battery_log(BAT_LOG_CRTI,"lwj total_charging_time=%d, battery_level=%d,ICharging_current=%d,bat_full=%d \n",
	                                  BMT_status.total_charging_time, BMT_status.UI_SOC, BMT_status.ICharging, BMT_status.bat_full);
	       
	       //Bad battery that can't be fully charged for 12 hours, 
	       //or device detects that battery can't be charged (Display continuously for 5 seconds)
	       if(((BMT_status.total_charging_time >= MAX_CHARGING_TIME) && (BMT_status.bat_in_recharging_state == false) && (BMT_status.UI_SOC < 100)) 
	               || ((BMT_status.bat_vol > Battery_charge_max_vol) )            
	         )
	       {
	               g_BatteryNotifyCode |= 0x0020;//the new value:0x0020 is for show_charger_badbattery_logo

			battery_log(BAT_LOG_CRTI,"lwj total_charging_time=%d, battery_level=%d,ICharging_current=%d,Charger_exist=%d \n",
	                                  BMT_status.total_charging_time, BMT_status.UI_SOC, BMT_status.ICharging, upmu_is_chr_det());
	                                          
	       }	   
		printk("lwj--%s--boot_mode=%d\n",__func__,g_platform_boot_mode);	
	}
}
//---add by lwj 20170523---}
static void mt_battery_notify_TatalChargingTime_check(void)
{
	...
	printk("lwj[BATTERY] BATTERY_NOTIFY_CASE_0005_TOTAL_CHARGINGTIME (%x)\n",
		    g_BatteryNotifyCode);		
	}
...
static void mt_battery_notify_VBat_check(void)
{
	...
	battery_log(BAT_LOG_FULL, "[BATTERY] BATTERY_NOTIFY_CASE_0004_VBAT (%x)\n",
		    g_BatteryNotifyCode);
	printk("lwj[BATTERY] BATTERY_NOTIFY_CASE_0004_VBAT (%x)\n",
		    g_BatteryNotifyCode);
#endif
}
...
static void mt_battery_notify_ICharging_check(void)
{
	...
	battery_log(BAT_LOG_CRTI, "[BATTERY] BATTERY_NOTIFY_CASE_0003_ICHARGING (%x)\n",
		    g_BatteryNotifyCode);
	printk("lwj[BATTERY] BATTERY_NOTIFY_CASE_0003_ICHARGING (%x)\n",
		    g_BatteryNotifyCode);
...
static void mt_battery_notify_VBatTemp_check(void)
{
	...
	if (BMT_status.temperature >= p_bat_charging_data->max_charge_temperature) {
		...
		battery_log(BAT_LOG_CRTI, "[BATTERY] bat_temp(%d) out of range\n",
			    BMT_status.temperature);
		printk("lwj--%s--tmp=%d ,max_tmp=%d,notify=%04x\n",__func__,BMT_status.temperature,p_bat_charging_data->max_charge_temperature,g_BatteryNotifyCode);		
	} else {
		g_BatteryNotifyCode &= ~(0x0002);
	}
...
static void mt_battery_notify_VCharger_check(void)
{
	...
	battery_log(BAT_LOG_FULL, "[BATTERY] BATTERY_NOTIFY_CASE_0001_VCHARGER (%x)\n",
		    g_BatteryNotifyCode);
	printk("lwj[BATTERY] BATTERY_NOTIFY_CASE_0001_VCHARGER (%x)\n",
		    g_BatteryNotifyCode);
#endif
}
...
void mt_battery_notify_check(void)
{
	...
	if (g_BN_TestMode == 0x0000) {	/* for normal case */
		...
		printk("lwj--bat_is_charger_exist=%d,upmu_is_chr_det=%d,is_otg_enable=%d\n",bat_is_charger_exist(),upmu_is_chr_det(),is_otg_enable);
		...
		mt_battery_notify_badbattery_check();
	} else {		/* for UI test */
		...
		if (BMT_status.temperature >= p_bat_charging_data->max_discharge_temperature) {
...
#else
			{
				if ((g_platform_boot_mode == META_BOOT)
					...
					/*if temperature >=60 power off system*/
					if (BMT_status.temperature >= 60) {
						...
						if (BMT_status.charger_exist)
							...
							orderly_poweroff(true);
						*/
						//add by lwj for power off system
						orderly_poweroff(true);
						//tlc
			           //mt_power_off(); 
					}
					else //if  (50 < temperature <60) stop charge  
					{
						//battery_log(BAT_LOG_ERROR,
						printk(
								"[Battery] Tbat(%d) > Tdischarge(%d), and < 60, discharge.\n",
								BMT_status.temperature,p_bat_charging_data->max_discharge_temperature);	
...
int bat_thread_kthread(void *x)
{
	...
	while (!fg_battery_shutdown) {
		...
		if (g_bat.usb_connect_ready == false) {
			...
			//Neostra huangjianlong 20170511
			if (upmu_is_chr_det() == true) {
				mt65xx_leds_brightness_set(0, 255); //red on
				mt65xx_leds_brightness_set(1, 0);   //green off				
				g_boot_red_on = true;
			}
		}
		
		//Neostra lwj 20170628
		if (upmu_is_chr_det() == false && g_loop_count<2) {
			mt65xx_leds_brightness_set(0, 0); //red off
			mt65xx_leds_brightness_set(1, 0); //green off
			g_loop_count++;
		}	
...
static int battery_probe(struct platform_device *pdev)
{
	...
	/* For EM */
	{
		...
		ret_device_file = device_create_file(dev, &dev_attr_bat_charging_data);//add by lwj for test 0510
#if defined(CONFIG_MTK_PUMP_EXPRESS_PLUS_SUPPORT)
...
static int mt_batteryNotify_probe(struct platform_device *pdev)
{
	...
	if (!battery_dir) {
		...
		//neostra tanguoliang for testimage
		//proc_create("current_cmd", S_IRUGO | S_IWUSR, battery_dir, &current_cmd_proc_fops);
		proc_create("current_cmd", 0x0777, battery_dir, &current_cmd_proc_fops);
		//end
