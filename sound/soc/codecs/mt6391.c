...
#include "neostra_control_woofer.h"
/* enum definition */
...
static void mt6391_turn_on_headphone_amp(struct mt6391_priv *codec_data)
{
	...
	if((gain_r ==4) && (gain_l == 4))
	{
		mt6391_set_reg(codec_data, MT6397_ZCD_CON2, 0x0A0A, 0xf0f);
	}else{
...
static void mt6391_turn_on_headset_speaker_amp(struct mt6391_priv *codec_data)
{
	...
	/* HP PGA gain */
	if(((gain_hpl == 4) || (gain_hpl == 0)) && ((gain_hpr == 4 ) || (gain_hpr == 0)))
	{
		mt6391_set_reg(codec_data, MT6397_ZCD_CON2, 0x0404, 0xf0f);
	}else{
	mt6391_set_reg(codec_data, MT6397_ZCD_CON2, ((gain_hpl << 8) | gain_hpr), 0xf0f);
	}
	//mt6391_set_reg(codec_data, MT6397_ZCD_CON2, 0x0A0A, 0xf0f);
	udelay(100);
